...
C                                                                           0055
      ...
      COMMON /MS5/ AEQ
      COMMON /MS6/ WORK
C      DIMENSION T(8192), SQRTW(8192), Y(8192), EXACT(8192), YLYFIT(8192)
      DIMENSION T(1000000), SQRTW(1000000), Y(1000000), EXACT(1000000),
     1 YLYFIT(1000000)
      DIMENSION G(5503), CQUAD(5503),VK1Y1(5503),S(5503,3),VALPHA(5503),
     1 VALPCV(5503), SOLUTN(5503), IISIGN(5503), SOLBES(5503),
     2 AA(5503,5503), SSCALE(5503)
      DIMENSION AINEQ(5501,5503), RHSNEQ(5501), LBIND(5501)
      DIMENSION A(5503,5503), IWORK(5503)
      DIMENSION REG(5504,5503)
      DIMENSION AEQ(11,5503), PIVOT(11)
      DIMENSION WORK(100253508)
...
C                                                                           0080
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     0083
     2 SRANGE                                                               0084
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,        0089
...
C                                                                           0099
      DATA MY/1000000/,MA/5503/,MG/5503/,MREG/5504/,MINEQ/5501/,MEQ/11/,
     1 MDONE/900/, MWORK/100253508/
C                                                                           0102
...
C  BLOCK DATA SUBPROGRAM.                                                   0184
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     0191
     2 SRANGE                                                               0192
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         0197
...
C      REAL, INTEGER, AND LOGICAL CONTROL VARIABLES, IN THAT ORDER.         0217
     ...
     1 RSVMNX/2*1., 2*0./, RUSER/110*0./,                                    0219
     2 SRMIN/.01/                                                           0220
      DATA ICRIT/2*1/,                                                      0221
     ...
     6 LINEPG/60/, LSIGN/80*0/, MIOERR/5/, MOMNMX/-1, 3/, MPKMOM/5/,        0227
...
C      IF NEQ=2 OR 3) WOULD HAVE TO HAVE BEEN PREVIOUSLY INPUT.             0270
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     0279
     2 SRANGE                                                               0280
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         0285
...
C-----------------------------------------------------------------------    0343
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     0351
     2 SRANGE                                                               0352
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         0357
...
C-----------------------------------------------------------------------    0407
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     0415
     2 SRANGE                                                               0416
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         0421
...
C-----------------------------------------------------------------------    0557
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),      0566
     2 SRANGE                                                               0567
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         0572
...
C-----------------------------------------------------------------------    0642
      ...
      DOUBLE PRECISION PRECIS, RANGE,USERK0,USERK1                          0644
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     0651
     2 SRANGE                                                               0652
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         0657
...
C-----------------------------------------------------------------------    0675
C              WRITE (*,*),'-T(JT))',T(JT),'G(JG)',G(JG)

C       userk0=-T(JT)*G(JG)**(-1.0)
C       WRITE (*,*),'-T(JT))',T(JT),'G(JG)',G(JG),'usk0',userk0
C       USERK1=EXP(-T(JT)*G(JG)**(-1.0))
        USERK=0
        IF(IUSER(10).ne.4)RUSER(21)=0
C        IF(IUSER(10).ne.4) WRITE(*,*) "HEY READ ME"
        IF(IUSER(10).ne.4)RUSER(22)=-1
       EX=T(JT)*G(JG)**(-1.0)
       IF (EX .LT. EXMAX)
     1 USERK=(RUSER(21)-(RUSER(22)*EXP(-T(JT)*G(JG)**(-1.0))))/G(JG)
C      write(*,*)RUSER(21) , RUSER(22), 'userk= ', userk
      RETURN                                                                0844
      END                                                                   0845
...
C-----------------------------------------------------------------------    0869
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     0877
     2 SRANGE                                                               0878
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         0883
...
C-----------------------------------------------------------------------    0920
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     0930
     2 SRANGE                                                               0931
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         0936
...
C-----------------------------------------------------------------------    1000
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     1004
     2 SRANGE                                                               1005
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         1010
...
C      SO THAT THE DATA IS ONLY READ ONCE.                                  1096
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     1105
     2 SRANGE                                                               1106
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         1111
...
C-----------------------------------------------------------------------    1178
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     1188
     2 SRANGE                                                               1189
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         1194
...
C-----------------------------------------------------------------------    1262
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     1270
     2 SRANGE                                                               1271
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         1276
...
C-----------------------------------------------------------------------    1318
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     1325
     2 SRANGE                                                               1326
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         1331
...
C      WHERE THE VARIANCE OF Y IS PROPORTIONAL TO (Y**2+1)/(4*Y**2).        1374
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     1382
     2 SRANGE                                                               1383
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         1388
...
C-----------------------------------------------------------------------    1414
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     1436
     2 SRANGE                                                               1437
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         1442
...
C-----------------------------------------------------------------------    1773
     ...
     1 NONNEG, ONLY1, PRWT, PRY, SIMULA, LUSER                              1784
      ...
      DIMENSION S(MG,3), LLSIGN(21), LSDONE(MDONE,3,2), VDONE(MDONE),       1786
     ...
     5 SQRTW(MY), T(MY), Y(MY), YLYFIT(MY), SSCALE(MG), RS2MNX(2)           1791
      DIMENSION IHOLER(6), ISTAR(4), JSTAGE(10), INC(20), PREJ(2),          1792
     1 VARTRY(20), LLSTRY(21,20), LLSBES(21)                                1793
      COMMON /DBLOCK/ PRECIS, RANGE                                         1794
      COMMON /SBLOCK/ DFMIN, SRMIN,                                         1795
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     1796
     2 SRANGE                                                               1797
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         1802
...
C      WRITE(*,*) "Entered subroutine ANPEAK"
      NSGNM1=NSGNI-1                                                        1809
      DONE=.FALSE.                                                          1810
      FLAT=.FALSE.                                                          1811
      NDONE=0                                                               1812
...
C-----------------------------------------------------------------------    1855
      DO 229 I = 1,10
C        WRITE(*,*) "ANPEAK LLSIGN", I, LLSIGN(I)
  229 CONTINUE
...
C-----------------------------------------------------------------------    1904
 5320 FORMAT (1X,A1,I4,1PE16.6,E16.5,E16.3,0PF14.3,2F12.3,8X,8I3)           1905
  320 DUM=SRANGE                                                            1906
 ...
 5322 FORMAT (1X,A1,I4,1PE16.6,78X,8I3)                                     1911
...
C  aSUBROUTINE GETROW.  LOADS ROW IROW OF SCALED AUGMENTED COEFFICIENT      2637
...
C-----------------------------------------------------------------------    2810
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     2821
     2 SRANGE                                                               2822
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         2827
...
C-----------------------------------------------------------------------    2869
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     2880
     2 SRANGE                                                               2881
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         2886
...
C-----------------------------------------------------------------------    3105
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     3128
     2 SRANGE                                                               3129
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         3134
...
C-----------------------------------------------------------------------    4270
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     4279
     2 SRANGE                                                               4280
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         4285
...
C-----------------------------------------------------------------------    4401
 ...
 5110 FORMAT (18H0(FOR ALPHA/S(1) =,1PE9.2,                                 4417
     1 9H) PRUNS =,0PF7.4,9X,8HPUNCOR =,5F8.4)                              4418
      ...
      GO TO 200                                                             4420
  150 CALL PLRES (YLYFIT,NY,NY,PRUNS,PUNCOR,RALPS1,NOUT,LINEPG,ITITLE,      4421
     1 CHOSEN)                                                              4422
...
C-----------------------------------------------------------------------    4734
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     4749
     2 SRANGE                                                               4750
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         4755
...
C-----------------------------------------------------------------------    4899
     ...
     1 SRANGE)                                                              4901
      ...
      DIMENSION LSIGN(4,INSGN), LLSIGN(21), SOLBES(NG)                       4903
      DIMENSION IHOLER(6)                                                   4904
      DATA IHOLER/1HS, 1HE, 1HT, 1HS, 1HG, 1HN/                             4905
      IF (NSGNI.LT.1 .OR. NSGNI.GT.19 .OR. IABS(LSIGN(1,INSGN)).NE.1)       4906
...
C        WRITE(*,*) "SETSGN LLSIGN", ISGN, LLSIGN(ISGN)
...
C-----------------------------------------------------------------------    5069
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     5078
     2 SRANGE                                                               5079
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         5084
...
C***********************************************************************    5116
  207 IF (IIN.LT.1 .OR. IIN.GT.110) GO TO 805                                5117
      RUSER(IIN)=RIN                                                        5118
      RETURN                                                                5119
...
C***********************************************************************    5152
  ...
  430 IF (IIN.LT.1 .OR. IIN.GT.2) GO TO 805                                 5156
      ...
      RETURN                                                                5158
 5431 FORMAT (80I1)                                                         5159
  431 READ (NIN,5431) LSIGN                                                 5160
      WRITE (NOUT,5431) LSIGN                                               5161
      IF (LSIGN(1,1).EQ.1) THEN
          DO 4311 J = 1,4
            DO 4312 I = 1,20
             LSIGN(I,J) = RUSER((J-1)*20+I+30)
 4312 CONTINUE
 4311 CONTINUE
      END IF
      RETURN                                                                5162
...
C      WRITE(*,*) "Entered subroutine UPDDON"
...
C-----------------------------------------------------------------------    5503
     ...
     1 LLSIGN,INC,DONE)                                                     5505
      LOGICAL DONE                                                          5506
      DIMENSION JSTAGE(NSGNI), VARTRY(NSGNI), LLSTRY(21,NSGNI),             5507
     1 LLSIGN(5), INC(NSGNI)                                                5508
      DIMENSION IHOLER(6)                                                   5509
      DATA IHOLER/1HU, 1HP, 1HD, 1HL, 1HL, 1HS/                             5510
C      WRITE(*,*) "Entered subroutine UPDLLS"
      IF (NSGNI .LE. 1) GO TO 790                                           5511
C      WRITE(*,*) "UPDLLS NSGNI", NSGNI
      DO 228 I = 1,NSGNI
C        WRITE(*,*) "UPDLLS JSTAGE(L)", I, JSTAGE(I)
  228 CONTINUE
      NSGNP1=NSGNI+1                                                        5512
      DO 235 J = 1,6
      DO 234 ITERA = 1,NSGNP1
C        WRITE(*,*) "Initial LLSTRY", ITERA, J, LLSTRY(ITERA,J)
  234 CONTINUE
  235 CONTINUE
      DONE=.FALSE.                                                          5513
      L=NSGNP1                                                              5514
...
C-----------------------------------------------------------------------    5526
        ...
        DO 227 ITER = 1,NSGNI
C          WRITE(*,*) "UPDLLS JSTAGE(L) 2", ITER, JSTAGE(ITER)
  227   CONTINUE
C        WRITE(*,*) "L value post 227", L
C        IF (L .LT. NSGNP1) WRITE(*,*) "One"
...
C-----------------------------------------------------------------------    5534
  ...
  310   CONTINUE                                                            5538
        DO 229 I = 1,NSGNP1
C          WRITE(*,*) "UPDLLS 300 BLOCK", I, L, LLSTRY(I,L)
  229 CONTINUE
        GO TO 350                                                           5539
C-----------------------------------------------------------------------    5540
...
C-----------------------------------------------------------------------    5543
  ...
  340   CONTINUE                                                            5547
        DO 222 I = 1,NSGNP1
C          WRITE(*,*) "UPDLLS POST 340", I, L, LLSTRY(I,L)
  222 CONTINUE
C-----------------------------------------------------------------------    5548
...
C          WRITE(*,*) "LLSTRY IN 350", LLSTRY(LL,L)
          LLSIGN(LL)=ISIGN(LLSTRY(LL,L),LLSIGN(LL))                         5553
  360   CONTINUE                                                            5554
      DO 243 I = 1,NSGNP1
C          WRITE(*,*) "UPDLLS POST 350 LLSTRY", I, L, LLSTRY(I,L)
C          WRITE(*,*) "UPDLLS POST 350 LLSGN", I, L, LLSIGN(I)
C          WRITE(*,*) "UPDLLS POST 350 LL", I, L, LL
  243 CONTINUE
        LL=LLSTRY(L,L)+INC(L)                                               5555
        LLSIGN(L)=ISIGN(LL,LLSIGN(L))                                       5556
        DO 230 I = 1,NSGNP1
C          WRITE(*,*) "UPDLLS POST 360 LLSTRY", I, L, LLSTRY(I,L)
C          WRITE(*,*) "UPDLLS POST 360 LLSIGN", I, L, LLSIGN(I)
C          WRITE(*,*) "UPDLLS POST 360 LL", I, L, LL
  230 CONTINUE
C                                                                           5557
...
C-----------------------------------------------------------------------    5698
     ...
     1 ALPST(2), EXMAX, GMNMX(2), PLEVEL(2,2), RSVMNX(2,2), RUSER(110),     5708
     2 SRANGE                                                               5709
     ...
     4 IUSROU(2), LSIGN(20,4), MOMNMX(2), NENDZ(2), NFLAT(4,2), NGL,         5714
